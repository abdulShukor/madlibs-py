def madlib():
    ...
    madlib = f"I love computer programming because it's {adjective1}! The journey to becoming a \
...
from developing {adjective3} software to analyzing data and making predictions about the {noun2}. You can \
maybe even recreate Jarvis and make him extra {adjective4}. I hope you'll start your {adjective5} journey by \
coding with XX :)"
